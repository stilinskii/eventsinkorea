...
public class EmailService{
    ...
    public void send(MailInfo mailInfo) {
        try{
            ...
            helper.setText(buildEmail(buildSentence(mailInfo.to,mailInfo.by, mailInfo.mailOption)), true);
            helper.setTo(mailInfo.email);
            helper.setFrom(sendFrom);

            if(mailInfo.mailOption == REQUESTED){
                helper.setSubject("buddy request arrived");

            }else if(mailInfo.mailOption == ACCEPTED){
                helper.setSubject("your buddy request has accepted");
            }else{
                helper.setSubject("Your buddy request has rejected");
            }
    ...
    private String buildEmail(String buildSentence) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Korean buddy</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
